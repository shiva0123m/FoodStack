...
1. Clone the repository:
    ```bash
    git clone https://github.com/shiva0123m/FoodStack.git
    ```
...
3. Configure MySQL Database:
    ...
    - Update `application.properties` with your MySQL credentials:
      ```properties
      spring.datasource.url=jdbc:mysql://localhost:3306/foodstack
...
Here is a preview of the FoodStack interface:
